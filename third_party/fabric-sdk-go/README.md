...
#### Testing with fabric-sdk-go-sample-gm
1.Clone fabric-sdk-go-sample-gm 
```
...
```
4.Start the fabric-sdk-go-sample-gm service
```
...
https://www.getpostman.com/collections/5508c6334e2e74b02bda
