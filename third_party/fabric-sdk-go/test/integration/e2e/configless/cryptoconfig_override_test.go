...
var (
	...
	securityHashAlgorithmImpl   = &exampleSecurityHashAlgorithm{}
...
type exampleSecurityHashAlgorithm struct{}
func (m *exampleSecurityAlgorithm) SecurityHashAlgorithm() string {
	return "SHA2"
}
